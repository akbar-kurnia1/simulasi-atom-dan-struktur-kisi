...
const ELEMENT_DATA = [
    null,
    {name:"Hydrogen",symbol:"H",commonNeutrons:0,stableNeutrons:[0,1],phase:"Gas",usage:"Bahan bakar bintang.",type:"nonmetal",config:"1s<sup class='-top-1'>1</sup>"},
    ...
    {name:"Lithium",symbol:"Li",commonNeutrons:4,stableNeutrons:[3,4],phase:"Padat",usage:"Baterai isi ulang.",type:"alkali-metal",config:"[He] 2s<sup class='-top-1'>1</sup>"},
    {name:"Beryllium",symbol:"Be",commonNeutrons:5,stableNeutrons:[5],phase:"Padat",usage:"Komponen teleskop.",type:"alkaline-earth-metal",config:"[He] 2s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Carbon",symbol:"C",commonNeutrons:6,stableNeutrons:[6,7],phase:"Padat",usage:"Dasar kehidupan.",type:"nonmetal",config:"[He] 2s<sup class='-top-1'>2</sup> 2p<sup class='-top-1'>2</sup>"},
    ...
    {name:"Oxygen",symbol:"O",commonNeutrons:8,stableNeutrons:[8,9,10],phase:"Gas",usage:"Pernapasan.",type:"nonmetal",config:"[He] 2s<sup class='-top-1'>2</sup> 2p<sup class='-top-1'>4</sup>"},
    {name:"Fluorine",symbol:"F",commonNeutrons:10,stableNeutrons:[10],phase:"Gas",usage:"Pasta gigi.",type:"halogen",config:"[He] 2s<sup class='-top-1'>2</sup> 2p<sup class='-top-1'>5</sup>"},
    ...
    {name:"Sodium (Natrium)",symbol:"Na",origin:"Natrium",commonNeutrons:12,stableNeutrons:[12],phase:"Padat",usage:"Garam dapur.",type:"alkali-metal",config:"[Ne] 3s<sup class='-top-1'>1</sup>"},
    ...
    {name:"Silicon",symbol:"Si",commonNeutrons:14,stableNeutrons:[14,15,16],phase:"Padat",usage:"Chip komputer.",type:"metalloid",config:"[Ne] 3s<sup class='-top-1'>2</sup> 3p<sup class='-top-1'>2</sup>"},
    {name:"Phosphorus",symbol:"P",commonNeutrons:16,stableNeutrons:[16],phase:"Padat",usage:"Ujung korek api.",type:"nonmetal",config:"[Ne] 3s<sup class='-top-1'>2</sup> 3p<sup class='-top-1'>3</sup>"},
    {name:"Sulfur (Belerang)",symbol:"S",commonNeutrons:16,stableNeutrons:[16,17,18,20],phase:"Padat",usage:"Asam sulfat.",type:"nonmetal",config:"[Ne] 3s<sup class='-top-1'>2</sup> 3p<sup class='-top-1'>4</sup>"},
    {name:"Chlorine",symbol:"Cl",commonNeutrons:18,stableNeutrons:[18,20],phase:"Gas",usage:"Disinfektan air.",type:"halogen",config:"[Ne] 3s<sup class='-top-1'>2</sup> 3p<sup class='-top-1'>5</sup>"},
    ...
    {name:"Potassium (Kalium)",symbol:"K",origin:"Kalium",commonNeutrons:20,stableNeutrons:[20,22],phase:"Padat",usage:"Fungsi saraf.",type:"alkali-metal",config:"[Ar] 4s<sup class='-top-1'>1</sup>"},
    {name:"Calcium",symbol:"Ca",commonNeutrons:20,stableNeutrons:[20,22,24,26,28],phase:"Padat",usage:"Tulang dan gigi.",type:"alkaline-earth-metal",config:"[Ar] 4s<sup class='-top-1'>2</sup>"},
    {name:"Scandium",symbol:"Sc",commonNeutrons:24,stableNeutrons:[24],phase:"Padat",usage:"Paduan logam ringan.",type:"transition-metal",config:"[Ar] 3d<sup class='-top-1'>1</sup> 4s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Chromium",symbol:"Cr",commonNeutrons:28,stableNeutrons:[26,28,29,30],phase:"Padat",usage:"Pelapisan logam.",type:"transition-metal",config:"[Ar] 3d<sup class='-top-1'>5</sup> 4s<sup class='-top-1'>1</sup>"},
    {name:"Manganese",symbol:"Mn",commonNeutrons:30,stableNeutrons:[30],phase:"Padat",usage:"Produksi baja.",type:"transition-metal",config:"[Ar] 3d<sup class='-top-1'>5</sup> 4s<sup class='-top-1'>2</sup>"},
    {name:"Iron (Besi)",symbol:"Fe",origin:"Ferrum",commonNeutrons:30,stableNeutrons:[28,30,31,32],phase:"Padat",usage:"Bahan bangunan utama.",type:"transition-metal",config:"[Ar] 3d<sup class='-top-1'>6</sup> 4s<sup class='-top-1'>2</sup>"},
    {name:"Cobalt",symbol:"Co",commonNeutrons:32,stableNeutrons:[32],phase:"Padat",usage:"Magnet, baterai.",type:"transition-metal",config:"[Ar] 3d<sup class='-top-1'>7</sup> 4s<sup class='-top-1'>2</sup>"},
    {name:"Nickel",symbol:"Ni",commonNeutrons:30,stableNeutrons:[30,32,33,34,36],phase:"Padat",usage:"Koin, baterai.",type:"transition-metal",config:"[Ar] 3d<sup class='-top-1'>8</sup> 4s<sup class='-top-1'>2</sup>"},
    {name:"Copper (Tembaga)",symbol:"Cu",origin:"Cuprum",commonNeutrons:34,stableNeutrons:[34,36],phase:"Padat",usage:"Kabel listrik.",type:"transition-metal",config:"[Ar] 3d<sup class='-top-1'>10</sup> 4s<sup class='-top-1'>1</sup>"},
    {name:"Zinc (Seng)",symbol:"Zn",commonNeutrons:35,stableNeutrons:[34,36,37,38,40],phase:"Padat",usage:"Pelapis anti karat.",type:"transition-metal",config:"[Ar] 3d<sup class='-top-1'>10</sup> 4s<sup class='-top-1'>2</sup>"},
    {name:"Gallium",symbol:"Ga",commonNeutrons:39,stableNeutrons:[38,40],phase:"Padat",usage:"Semikonduktor, LED.",type:"post-transition-metal",config:"[Ar] 3d<sup class='-top-1'>10</sup> 4s<sup class='-top-1'>2</sup> 4p<sup class='-top-1'>1</sup>"},
    ...
    {name:"Arsenic",symbol:"As",commonNeutrons:42,stableNeutrons:[42],phase:"Padat",usage:"Racun, semikonduktor.",type:"metalloid",config:"[Ar] 3d<sup class='-top-1'>10</sup> 4s<sup class='-top-1'>2</sup> 4p<sup class='-top-1'>3</sup>"},
    ...
    {name:"Bromine",symbol:"Br",commonNeutrons:44,stableNeutrons:[44,46],phase:"Cair",usage:"Anti api.",type:"halogen",config:"[Ar] 3d<sup class='-top-1'>10</sup> 4s<sup class='-top-1'>2</sup> 4p<sup class='-top-1'>5</sup>"},
    {name:"Krypton",symbol:"Kr",commonNeutrons:48,stableNeutrons:[42,44,46,47,48,50],phase:"Gas",usage:"Lampu kilat fotografi.",type:"noble-gas",config:"[Ar] 3d<sup class='-top-1'>10</sup> 4s<sup class='-top-1'>2</sup> 4p<sup class='-top-1'>6</sup>"},
    ...
    {name:"Strontium",symbol:"Sr",commonNeutrons:50,stableNeutrons:[46,48,49,50],phase:"Padat",usage:"Kembang api merah.",type:"alkaline-earth-metal",config:"[Kr] 5s<sup class='-top-1'>2</sup>"},
    {name:"Yttrium",symbol:"Y",commonNeutrons:50,stableNeutrons:[50],phase:"Padat",usage:"Layar TV tabung (dulu).",type:"transition-metal",config:"[Kr] 4d<sup class='-top-1'>1</sup> 5s<sup class='-top-1'>2</sup>"},
    {name:"Zirconium",symbol:"Zr",commonNeutrons:51,stableNeutrons:[50,51,52,54,56],phase:"Padat",usage:"Reaktor nuklir.",type:"transition-metal",config:"[Kr] 4d<sup class='-top-1'>2</sup> 5s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Molybdenum",symbol:"Mo",commonNeutrons:54,stableNeutrons:[50,52,53,54,55,56,58],phase:"Padat",usage:"Paduan baja.",type:"transition-metal",config:"[Kr] 4d<sup class='-top-1'>5</sup> 5s<sup class='-top-1'>1</sup>"},
    {name:"Technetium",symbol:"Tc",commonNeutrons:55,phase:"Padat",usage:"Diagnostik medis.",type:"transition-metal",config:"[Kr] 4d<sup class='-top-1'>5</sup> 5s<sup class='-top-1'>2</sup>"},
    {name:"Ruthenium",symbol:"Ru",commonNeutrons:58,stableNeutrons:[52,54,55,56,57,58,60],phase:"Padat",usage:"Kontak listrik.",type:"transition-metal",config:"[Kr] 4d<sup class='-top-1'>7</sup> 5s<sup class='-top-1'>1</sup>"},
    {name:"Rhodium",symbol:"Rh",commonNeutrons:58,stableNeutrons:[58],phase:"Padat",usage:"Katalis knalpot.",type:"transition-metal",config:"[Kr] 4d<sup class='-top-1'>8</sup> 5s<sup class='-top-1'>1</sup>"},
    {name:"Palladium",symbol:"Pd",commonNeutrons:60,stableNeutrons:[58,60,62,63,64,66],phase:"Padat",usage:"Katalis knalpot.",type:"transition-metal",config:"[Kr] 4d<sup class='-top-1'>10</sup>"},
    {name:"Silver (Perak)",symbol:"Ag",origin:"Argentum",commonNeutrons:61,stableNeutrons:[60,62],phase:"Padat",usage:"Perhiasan, konduktor.",type:"transition-metal",config:"[Kr] 4d<sup class='-top-1'>10</sup> 5s<sup class='-top-1'>1</sup>"},
    {name:"Cadmium",symbol:"Cd",commonNeutrons:66,stableNeutrons:[60,62,64,65,66,68],phase:"Padat",usage:"Baterai Ni-Cd.",type:"transition-metal",config:"[Kr] 4d<sup class='-top-1'>10</sup> 5s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Tin (Timah)",symbol:"Sn",origin:"Stannum",commonNeutrons:70,stableNeutrons:[62,64,65,66,67,68,69,70,72,74],phase:"Padat",usage:"Solder, pelapis.",type:"post-transition-metal",config:"[Kr] 4d<sup class='-top-1'>10</sup> 5s<sup class='-top-1'>2</sup> 5p<sup class='-top-1'>2</sup>"},
    {name:"Antimony (Antimon)",symbol:"Sb",origin:"Stibium",commonNeutrons:71,stableNeutrons:[70,72],phase:"Padat",usage:"Baterai timbal.",type:"metalloid",config:"[Kr] 4d<sup class='-top-1'>10</sup> 5s<sup class='-top-1'>2</sup> 5p<sup class='-top-1'>3</sup>"},
    {name:"Tellurium",symbol:"Te",commonNeutrons:76,stableNeutrons:[70,72,73,74,75,76,78],phase:"Padat",usage:"Paduan logam.",type:"metalloid",config:"[Kr] 4d<sup class='-top-1'>10</sup> 5s<sup class='-top-1'>2</sup> 5p<sup class='-top-1'>4</sup>"},
    {name:"Iodine",symbol:"I",commonNeutrons:74,stableNeutrons:[74],phase:"Padat",usage:"Antiseptik.",type:"halogen",config:"[Kr] 4d<sup class='-top-1'>10</sup> 5s<sup class='-top-1'>2</sup> 5p<sup class='-top-1'>5</sup>"},
    ...
    {name:"Cesium (Sesium)",symbol:"Cs",commonNeutrons:78,stableNeutrons:[78],phase:"Padat",usage:"Jam atom.",type:"alkali-metal",config:"[Xe] 6s<sup class='-top-1'>1</sup>"},
    ...
    {name:"Lanthanum",symbol:"La",commonNeutrons:82,stableNeutrons:[82],phase:"Padat",usage:"Lensa kamera.",type:"lanthanide",config:"[Xe] 5d<sup class='-top-1'>1</sup> 6s<sup class='-top-1'>2</sup>"},
    {name:"Cerium",symbol:"Ce",commonNeutrons:82,stableNeutrons:[78,80,82,84],phase:"Padat",usage:"Batu geretan.",type:"lanthanide",config:"[Xe] 4f<sup class='-top-1'>1</sup> 5d<sup class='-top-1'>1</sup> 6s<sup class='-top-1'>2</sup>"},
    {name:"Praseodymium",symbol:"Pr",commonNeutrons:82,stableNeutrons:[82],phase:"Padat",usage:"Kacamata las.",type:"lanthanide",config:"[Xe] 4f<sup class='-top-1'>3</sup> 6s<sup class='-top-1'>2</sup>"},
    {name:"Neodymium",symbol:"Nd",commonNeutrons:84,stableNeutrons:[82,83,84,85,86,88,90],phase:"Padat",usage:"Magnet super kuat.",type:"lanthanide",config:"[Xe] 4f<sup class='-top-1'>4</sup> 6s<sup class='-top-1'>2</sup>"},
    {name:"Promethium",symbol:"Pm",commonNeutrons:84,phase:"Padat",usage:"Cat berpendar.",type:"lanthanide",config:"[Xe] 4f<sup class='-top-1'>5</sup> 6s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Dysprosium",symbol:"Dy",commonNeutrons:99,stableNeutrons:[94,96,97,98,99,100,102],phase:"Padat",usage:"Magnet motor hibrida.",type:"lanthanide",config:"[Xe] 4f<sup class='-top-1'>10</sup> 6s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Thulium",symbol:"Tm",commonNeutrons:100,stableNeutrons:[100],phase:"Padat",usage:"Mesin X-ray portabel.",type:"lanthanide",config:"[Xe] 4f<sup class='-top-1'>13</sup> 6s<sup class='-top-1'>2</sup>"},
    {name:"Ytterbium",symbol:"Yb",commonNeutrons:103,stableNeutrons:[100,102,103,104,106,108],phase:"Padat",usage:"Laser inframerah.",type:"lanthanide",config:"[Xe] 4f<sup class='-top-1'>14</sup> 6s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Tungsten (Wolfram)",symbol:"W",origin:"Wolfram",commonNeutrons:110,stableNeutrons:[108,110,111,112,114],phase:"Padat",usage:"Filamen bola lampu.",type:"transition-metal",config:"[Xe] 4f<sup class='-top-1'>14</sup> 5d<sup class='-top-1'>4</sup> 6s<sup class='-top-1'>2</sup>"},
    {name:"Rhenium",symbol:"Re",commonNeutrons:111,stableNeutrons:[110,112],phase:"Padat",usage:"Mesin jet.",type:"transition-metal",config:"[Xe] 4f<sup class='-top-1'>14</sup> 5d<sup class='-top-1'>5</sup> 6s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Platinum (Platina)",symbol:"Pt",commonNeutrons:117,stableNeutrons:[114,115,116,117,118,120],phase:"Padat",usage:"Perhiasan, katalis.",type:"transition-metal",config:"[Xe] 4f<sup class='-top-1'>14</sup> 5d<sup class='-top-1'>9</sup> 6s<sup class='-top-1'>1</sup>"},
    {name:"Gold (Emas)",symbol:"Au",origin:"Aurum",commonNeutrons:118,stableNeutrons:[118],phase:"Padat",usage:"Perhiasan, elektronik.",type:"transition-metal",config:"[Xe] 4f<sup class='-top-1'>14</sup> 5d<sup class='-top-1'>10</sup> 6s<sup class='-top-1'>1</sup>"},
    {name:"Mercury (Raksa)",symbol:"Hg",origin:"Hydrargyrum",commonNeutrons:122,stableNeutrons:[118,120,121,122,124,126],phase:"Cair",usage:"Termometer (dulu).",type:"transition-metal",config:"[Xe] 4f<sup class='-top-1'>14</sup> 5d<sup class='-top-1'>10</sup> 6s<sup class='-top-1'>2</sup>"},
    {name:"Thallium",symbol:"Tl",commonNeutrons:123,stableNeutrons:[122,124],phase:"Padat",usage:"Detektor inframerah.",type:"post-transition-metal",config:"[Xe] 4f<sup class='-top-1'>14</sup> 5d<sup class='-top-1'>10</sup> 6s<sup class='-top-1'>2</sup> 6p<sup class='-top-1'>1</sup>"},
    {name:"Lead (Timbal)",symbol:"Pb",origin:"Plumbum",commonNeutrons:126,stableNeutrons:[122,124,125,126],phase:"Padat",usage:"Baterai mobil (aki).",type:"post-transition-metal",config:"[Xe] 4f<sup class='-top-1'>14</sup> 5d<sup class='-top-1'>10</sup> 6s<sup class='-top-1'>2</sup> 6p<sup class='-top-1'>2</sup>"},
    {name:"Bismuth",symbol:"Bi",commonNeutrons:126,stableNeutrons:[126],phase:"Padat",usage:"Obat sakit perut.",type:"post-transition-metal",config:"[Xe] 4f<sup class='-top-1'>14</sup> 5d<sup class='-top-1'>10</sup> 6s<sup class='-top-1'>2</sup> 6p<sup class='-top-1'>3</sup>"},
    ...
    {name:"Astatine",symbol:"At",commonNeutrons:125,phase:"Padat",usage:"Terapi kanker.",type:"halogen",config:"[Xe] 4f<sup class='-top-1'>14</sup> 5d<sup class='-top-1'>10</sup> 6s<sup class='-top-1'>2</sup> 6p<sup class='-top-1'>5</sup>"},
    ...
    {name:"Francium",symbol:"Fr",commonNeutrons:136,phase:"Padat",usage:"Penelitian ilmiah.",type:"alkali-metal",config:"[Rn] 7s<sup class='-top-1'>1</sup>"},
    ...
    {name:"Actinium",symbol:"Ac",commonNeutrons:138,phase:"Padat",usage:"Sumber neutron.",type:"actinide",config:"[Rn] 6d<sup class='-top-1'>1</sup> 7s<sup class='-top-1'>2</sup>"},
    {name:"Thorium",symbol:"Th",commonNeutrons:142,phase:"Padat",usage:"Bahan bakar nuklir.",type:"actinide",config:"[Rn] 6d<sup class='-top-1'>2</sup> 7s<sup class='-top-1'>2</sup>"},
    {name:"Protactinium",symbol:"Pa",commonNeutrons:140,phase:"Padat",usage:"Penelitian ilmiah.",type:"actinide",config:"[Rn] 5f<sup class='-top-1'>2</sup> 6d<sup class='-top-1'>1</sup> 7s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Americium",symbol:"Am",commonNeutrons:152,phase:"Padat",usage:"Detektor asap.",type:"actinide",config:"[Rn] 5f<sup class='-top-1'>7</sup> 7s<sup class='-top-1'>2</sup>"},
    {name:"Curium",symbol:"Cm",commonNeutrons:153,phase:"Padat",usage:"Penelitian ilmiah.",type:"actinide",config:"[Rn] 5f<sup class='-top-1'>7</sup> 6d<sup class='-top-1'>1</sup> 7s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Californium",symbol:"Cf",commonNeutrons:153,phase:"Padat",usage:"Memulai reaktor nuklir.",type:"actinide",config:"[Rn] 5f<sup class='-top-1'>10</sup> 7s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Lawrencium",symbol:"Lr",commonNeutrons:161,phase:"Padat",usage:"Penelitian ilmiah.",type:"actinide",config:"[Rn] 5f<sup class='-top-1'>14</sup> 7s<sup class='-top-1'>2</sup> 7p<sup class='-top-1'>1</sup>"},
    ...
    {name:"Copernicium",symbol:"Cn",commonNeutrons:173,phase:"Gas (diprediksi)",usage:"Penelitian ilmiah.",type:"transition-metal",config:"[Rn] 5f<sup class='-top-1'>14</sup> 6d<sup class='-top-1'>10</sup> 7s<sup class='-top-1'>2</sup>"},
    ...
    {name:"Moscovium",symbol:"Mc",commonNeutrons:174,phase:"Padat (diprediksi)",usage:"Penelitian ilmiah.",type:"post-transition-metal",config:"[Rn] 5f<sup class='-top-1'>14</sup> 6d<sup class='-top-1'>10</sup> 7s<sup class='-top-1'>2</sup> 7p<sup class='-top-1'>3</sup>"},
    ...
    {name:"Tennessine",symbol:"Ts",commonNeutrons:177,phase:"Padat (diprediksi)",usage:"Penelitian ilmiah.",type:"halogen",config:"[Rn] 5f<sup class='-top-1'>14</sup> 6d<sup class='-top-1'>10</sup> 7s<sup class='-top-1'>2</sup> 7p<sup class='-top-1'>5</sup>"},
...
function updateInfoPanel() {
    ...
    const m = p + n;
    const d = ELEMENT_DATA[p] || { name: `Unsur #${p}`, phase: '-', usage: '-', stableNeutrons: [] };
    const c = p - appState.electrons;
    const s = domElements.coreStability;
    
    // --- Elemen DOM baru ---
    const originRow = domElements.symbolOriginRow;
    const originSpan = domElements.elementSymbolOrigin;

    // --- Isi data ---
    domElements.elementName.textContent = d.name;
    domElements.atomicNumber.textContent = p;
    domElements.massNumber.textContent = m;
    domElements.isotopeName.textContent = `${d.symbol}-${m}`; // Memperbaiki ini agar menampilkan simbol (misal: C-14)
    domElements.elementPhase.textContent = d.phase;
    domElements.elementUsage.textContent = d.usage;
    domElements.charge.textContent = c > 0 ? `+${c}` : c;
    domElements.electronConfigString.innerHTML = d.config || '-';
    
    // --- Logika untuk Asal Simbol ---
    if (d.origin) {
        originSpan.textContent = d.origin;
        originRow.classList.remove('hidden');
    } else {
        originSpan.textContent = ''; // Kosongkan
        originRow.classList.add('hidden'); // Sembunyikan jika tidak ada data
    }

    // --- Logika Stabilitas Inti ---
    if (p > 83) {
        s.textContent = 'Radioaktif';
        s.className = 'font-bold stability-tidak-stabil';
    } else {
        const t = d.stableNeutrons.includes(n);
        s.textContent = t ? 'Stabil' : 'Tidak Stabil';
        s.className = `font-bold ${t ? 'stability-stabil' : 'stability-tidak-stabil'}`;
    }
}
...
function cacheDOMElements() {
    const ids = [
        'bg','title-panel','main-title','main-subtitle','mode-switch-btn',
        'atom-sim-ui','lattice-sim-ui','info-panel','show-info-btn','element-name',
        'atomic-number','mass-number','charge','isotope-name','core-stability',
        'element-phase','element-usage','electron-config-string','view-toggle-text',
        'sun-icon','moon-icon','structure-toggle-btn','expansion-toggle-btn',
        'atom-expansion-slider-container','atom-expansion-slider','toggle-nucleus',
        'periodic-table-modal','performance-warning-modal','continue-warning-btn',
        'periodic-table-grid','info-header','info-arrow','periodic-table-backdrop',
        'cancel-warning-btn','add-proton','add-neutron','add-electron','remove-proton',
        'remove-neutron','remove-electron','reset-atom','periodic-table-btn',
        'theme-toggle-btn','view-toggle-btn','zoom-in-btn','zoom-out-btn','about-btn',
        'about-modal','close-about-btn','about-modal-backdrop','lattice-controls-panel',
        'lattice-type-select','lattice-display-controls','lattice-expansion-slider-container',
        'lattice-expansion-slider','lattice-info-panel','lattice-coordination-number',
        'lattice-apf','lattice-parameter-relation','toggle-outline-btn',
        'lattice-controls-header','show-lattice-controls-btn','lattice-info-header',
        'show-lattice-info-btn','lattice-controls-arrow','lattice-info-arrow',
        'lattice-controls-content','lattice-info-content','lattice-contribution-section',
        'contribution-corners','contribution-faces','contribution-body','contribution-total',
        'symbol-origin-row','element-symbol-origin'
    ];
    ids.forEach(id => {
        const c = id.replace(/-([a-z])/g, g => g[1].toUpperCase());
        domElements[c] = document.getElementById(id);
    });
}
